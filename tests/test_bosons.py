...
def test_bosons():
    ...
    data = [1.+0.j, 1.+0.j, 1.+0.j, 1.41421356237+0.j]
    indices = [0, 1, 3, 6]
    indptr = [0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4]
    ...
    data = [1.+0.j, 1.+0.j, 1.41421356237+0.j, 1.+0.j]
    indices = [0, 1, 3, 6]
