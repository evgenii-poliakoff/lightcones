c
c This file is taken from the package of routines, called ORTHPOL, for generating 
c orthogonal polynomials and Gauss-type quadrature rules developed
c by Walter Gautschi.
c Original package can be downloaded from
c https://dl.acm.org/doi/10.1145/174603.174605
c A description of the underlying methods can be
c found in a companion paper published in ACM Transactions on
c Mathematical Software'', vol. 20 (1994), pp.21-62.
c
      subroutine dlancz(n,ncap,x,w,alpha,beta,ierr,dp0,dp1)
c
c This is a double-precision version of the routine  lancz.
c
      real*8 x(ncap),w(ncap),alpha(n),beta(n),
